...
class Puppet::Util::NetworkDevice::NexusRestApi; end

# The NexusRestApi module only contains the Device class to bridge from puppet's internals to the Transport.
# All the heavy lifting is done bye the Puppet::ResourceApi::Transport::Wrapper
class Puppet::Util::NetworkDevice::NexusRestApi::Device < Puppet::ResourceApi::Transport::Wrapper
