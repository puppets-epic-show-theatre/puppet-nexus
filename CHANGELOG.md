...
## [5.0.1]
### Changed
- API requests to manage resources now prefer given credentials instead of nexus password file
- `nexus::plugin::composer` disables sonatype composer plugin on version 3.75+
